...
# 2 
# Create a Table
def creating_dict(names, months, years, max_sustained_winds, areas_affected, updated_damages, deaths):
  hurricanes = {}
...
hurricanes = creating_dict(names, months, years, max_sustained_winds, areas_affected, updated_damages, deaths)
...
def cal_max_hurricount(affected_area_count):
  max_area = 'Central America'
  max_area_count = 0
  for area, count in affected_area_count.items():
    if count > max_area_count:
      max_area = area
      max_area_count = count
    return max_area, max_area_count

max_count_area = cal_max_hurricount(affected_area_count)

print(max_count_area)
# 6
# Calculating the Deadliest Hurricane

# find highest mortality hurricane and the number of deaths
def cal_max_deaths(hurricanes):
  deaths = 0
  the_cane = 'Cuba I'
  for cane in hurricanes:
    if hurricanes[cane]["Deaths"] > deaths:
      ...
      the_cane = cane
  return the_cane, deaths

print(cal_max_deaths(hurricanes))
